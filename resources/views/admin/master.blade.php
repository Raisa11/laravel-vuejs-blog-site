...
<head>
    ...
    <link rel="stylesheet" media="screen" type="text/css" href="{{asset('/')}}admin/plugins/css/datepicker.css" />
...
<div class="wrapper">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                   ...
                   @endif
                    ...
                    <li class="nav-item has-treeview">
                        <a href="{{url('/registered-user')}}" class="nav-link">
  ...
  @yield('body')
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020   Daily Blogs.</strong> All rights
        reserved.
    </footer>
...
<script type="text/javascript" src="{{asset('/')}}admin/plugins/js/datepicker.js"></script>
<script>
    $('#date').DatePicker({
        flat: true,
        date: '2008-07-31',
